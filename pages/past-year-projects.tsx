...
},
{
  ...
  textRightAlign: true,
},
		{
			...
			description: "RPillPal is a biometric-based pill dispenser designed for home use. Its goal is to utilize biometric fingerprint data to determine patient identity and supply the correct dose based on doctor recommendations. It connects directly with a patient's healthcare providers, allowing them to monitor progress and make timely adjustments to treatment plans.",
			imageUrl: "/projectImages/patientsafety.png",
		},
		{
			title: "Ed-You",
			authors: ["Name 1", "Name 2", "Name 3", "Name 4"],
			description: "Ed-You is a web application that creates a direct channel for secure feedback from students about teachers to administration. Ed-You is catered to two main audiences: students and administrators. Students enter their school code, which is randomly generated and available to the admin in their school, and are able to choose from a list of teachers at their school and provide anonymous feedback whenever they want. The only restriction to student-feedback is toxicity: the application uses a fine-tuned large language model to flag any potentially harmful comments and force the student to reword them. On the administration side, admins can log in through Google OAuth to access their dashboard. A list of teachers from their school will be visible, and admins can click on any teacher to learn more about the feedback given to them. This feedback takes the form of an average rating calculated by another fine-tuned LLM, an AI-generated summary, and raw comments with time stamps.",
...
<div className="flex flex-col items-center h-full mx-8"> {/* Added horizontal margins here */}
  <img src={otherProjects[currentIndex].imageUrl} alt={otherProjects[currentIndex].title} className="w-full h-full object-cover" />
</div>
<div className="flex items-center bg-gray-200 p-4" style={{ height: '70%' }}>
