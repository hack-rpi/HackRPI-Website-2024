	...
	return (
		...
		>
			<div className="w-1/3 mx-2 h-2/3 bg-gradient-to-b from-silver via-gray-300  to-hackrpi-secondary-dark-blue flex flex-col items-center justify-start">
				<h1 className="text-hackrpi-secondary-dark-blue font-bold font-sans text-lg xs:text-2xl sm:text-4xl mt-2">{podiumPrizes[1].name}</h1>
			...
			<div className="w-1/3 mx-2 h-full bg-gradient-to-b from-gold via-yellow-300   to-hackrpi-secondary-dark-blue flex flex-col items-center justify-start">
				<h1 className="text-hackrpi-secondary-dark-blue font-bold font-sans text-lg xs:text-2xl sm:text-4xl mt-2">{podiumPrizes[0].name}</h1>
				<h2 className="text-hackrpi-secondary-dark-blue font-bold font-sans text-lg xs:text-2xl sm:text-4xl mt-2">
