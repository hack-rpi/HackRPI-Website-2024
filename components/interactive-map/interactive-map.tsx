...
export default function InteractiveNavigationMap() {
	return (
		<div className="relative w-full aspect-square flex items-center justify-center h-fit p-8">
			...
			<div className="absolute z-10 flex flex-col text-lg lg:text-xl xl:text-2xl 2xl:text-4xl top-8 lg:top-10 2xl:top-12 left-[18%] lg:left-[16.8%] xl:left-[15.5%] 2xl:left-[15%]">
				{links.map((link) => (
