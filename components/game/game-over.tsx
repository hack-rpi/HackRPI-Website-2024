...
const GameOver = ({ onSubmitClose, onExitClose }: { onSubmitClose: (username: string) => void, onExitClose: () => void }) => {
    const onSubmit = () => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-0" onClick={onExitClose}>
            <div className="bg-[#213445] p-6 rounded-lg shadow-lg flex flex-col items-center justify-center z-20" onClick={(event)=> event.stopPropagation()}>
