		...
		<div className="bg-hackrpi-secondary-dark-blue w-full h-16">
			<div className="flex justify-start lg:justify-center items-center h-full">
				...
				<div className="min-w-fit lg:w-8/12 flex items-center justify-start">
					...
					<Link href="https://static.mlh.io/docs/mlh-code-of-conduct.pdf" className="mx-2 whitespace-nowrap text-lg xl:text-xl bg-[length:0%_2px] bg-no-repeat bg-left-bottom transition-all duration-200 bg-gradient-to-r from-hackrpi-primary-blue to-hackrpi-primary-blue hover:bg-[length:100%_2px]" target="_blank">Code of Conduct</Link>
				</div>
