...
const Arrow: React.FC<ArrowProps> = React.memo(({ direction, onClick }) => (
	<button onClick={onClick} className="bg-gray-200 rounded-md p-2 hover:bg-gray-300 transition-colors duration-200">
		<svg
