	...
	return (
		<div className="flex flex-col w-full h-fit min-h-screen items-center justify-center">
			...
			<div className="flex flex-col w-full flex-grow flex-shrink basis-auto mt-24 lg:mt-16 items-center">
                ...
                <p className="text-lg sm:text-xl font-sans my-4 text-center w-11/12">Please make sure you are at your assigned room at least 5 minutes before your assigned time! Thank you!</p>
                <p className="text-lg sm:text-xl font-sans my-4 text-center">The judging schedule will be released around 10:45 am on November 10th.</p>
